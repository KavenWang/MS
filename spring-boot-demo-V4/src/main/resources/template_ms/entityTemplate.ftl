package com.hoperun.scfs.preloan.domain;
 ...
 */
@Entity
@Table(name = "${tableBean.tableName}", schema = "")
@SuppressWarnings("serial")
public class ${tableBean.className} implements Serializable {
...
<#list entityClassList as en>
  <#if en.pkField=='1'>
	  ...
	  @Column(name ="${en.columnName}",nullable=false)
